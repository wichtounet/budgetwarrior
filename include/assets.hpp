...
budget::money get_asset_value(const budget::asset & asset, const std::vector<budget::asset_value> & asset_values);
budget::money get_asset_value(const budget::asset & asset, budget::date d, const std::vector<budget::asset_value> & asset_values);

// The value of an asset in the default currency
budget::money get_asset_value_conv(const budget::asset & asset, const std::vector<budget::asset_value> & asset_values);
budget::money get_asset_value_conv(const budget::asset & asset, budget::date d, const std::vector<budget::asset_value> & asset_values);

// The value of an asset in a specific currency
budget::money get_asset_value_conv(const budget::asset & asset, const std::string& currency, const std::vector<budget::asset_value> & asset_values);
budget::money get_asset_value_conv(const budget::asset & asset, budget::date d, const std::string& currency, const std::vector<budget::asset_value> & asset_values);
